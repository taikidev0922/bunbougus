...
@section('content')
    ...
    <div style="text-align:right">
        <form action="{{route('bunbougu.update',$bunbougu)}}" method="POST">
            ...
            <div class="col-12 mb-2 mt-2">
                <div class="form-group">
                    <input type="text" name="kakaku" class="form-control" placeholder="価格" value="{{$bunbougu->kakaku}}">
                    @error('kakaku')
            ...
            <div class="col-12 mb-2 mt-2">
                <div class="form-group">
                    <select name="bunrui" class="form-select" value="{{$bunbougu->bunrui}}">
            ...
            <div class="col-12 mb-2 mt-2">
                <div class="form-group">
                    <textarea name="shosai" style="height:100px" name="shosai" >{{$bunbougu->shosai}}</textarea>
                    @error('shosai')
